...
urlpatterns = [
    ...
    path("api/admin/metrics/summary", views.metrics_summary),
    path("api/admin/rag/upload", views.rag_upload),
    path("api/admin/rag/documents", views.rag_documents),
    path("api/admin/rag/documents/<str:document_id>", views.rag_document_detail),
    path("api/admin/rag/documents/<str:document_id>/index", views.rag_document_index),
    path("api/admin/rag/search", views.rag_search),
    path("api/admin/rag/answer", views.rag_answer),
